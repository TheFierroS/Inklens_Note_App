...
const NoteDetailModal = ({ note, isOpen, onClose }) => {
    ...
    const parseContentWithImages = (content) => {
        ...
        return <div className="whitespace-pre-wrap break-words overflow-wrap-anywhere">{elements}</div>;
    };
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className="p-4 max-h-[80vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto overflow-x-hidden pr-2 mb-4">
                    <p className={`whitespace-pre-wrap break-words ${theme === "light" ? "text-gray-700" : "text-gray-200"}`}>
                ...
                <button
                    onClick={handleCopy}
                    className="px-3 py-1 bg-[#ff008d] text-white rounded hover:bg-[#cc0070] w-auto self-start mt-2"
                >
                    Copy
                </button>
